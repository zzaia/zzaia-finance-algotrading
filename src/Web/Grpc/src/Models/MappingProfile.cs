    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            CreateMap<OrderBook, OrderBookDTO>()
                ...
                .ForMember(dst => dst.ServerTimeStamp, opt => opt.MapFrom(src => src.ServerTimeStamp.ToString()));
            CreateMap<OrderBookDTO, OrderBook>()
                ...
                .ForMember(dst => dst.ServerTimeStamp, opt => opt.MapFrom(src => DateTimeOffset.Parse(src.ServerTimeStamp)));
            ...
            CreateMap<EventSourceDTO, EventSource<OrderBook>>()
                ...
                .ForMember(dst => dst.RecordedAt, opt => opt.MapFrom(src => DateTimeOffset.Parse(src.RecordedAt)))
                .ForMember(dst => dst.OcurredAt, opt => opt.MapFrom(src => DateTimeOffset.Parse(src.OcurredAt)));
            CreateMap<EventSource<OrderBook>, EventSourceDTO>()
                ...
                .ForMember(dst => dst.RecordedAt, opt => opt.MapFrom(src => src.RecordedAt.ToString()))
                .ForMember(dst => dst.OcurredAt, opt => opt.MapFrom(src => src.OcurredAt.ToString()));
        }
    }
}
