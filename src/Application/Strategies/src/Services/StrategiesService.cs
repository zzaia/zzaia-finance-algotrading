...
namespace MarketIntelligency.Application.Strategies.Services
{

    public class StrategiesService : AppCallback.AppCallbackBase
    {
        ...
        public StrategiesService(IDataStreamSource dataStreamSource, ILogger<StrategiesService> logger)
        {
