...
dapr run --app-id "binance-adapter" --app-protocol "grpc" --app-port "5001" --dapr-grpc-port "50010" -- dotnet run --project ./src/Application/Adapter/Binance/src/MarketIntelligency.Application.Adapter.Binance.csproj --urls="http://+:5001"
